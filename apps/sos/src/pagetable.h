...
typedef struct {
    ...
    seL4_CPtr *kernel_cap_table; /* virtual address to an array of in-kernel page table caps */
} page_directory_t;
...
int cap_table_insert(page_directory_t *table, seL4_Word page_id, seL4_CPtr cap);
